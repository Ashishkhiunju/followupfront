...
export const LoanForm = (props) => {
  ...
  const onChangeStartDate = ({ bsDate, adDate }) => {
    ...
    axios
      .get(`/api/convertdate`, {
        params: { convertto: "nepali", date: converteddate },
      })
      .then(({ data }) => {
              ...
              <div className="section">
                ...
                <div className="row">
                  ...
                  <div className="btn-group text-center d-block">
                    <button className="cl-btn" disabled={buttonDisabled}>
                      Save Details
                    </button>
                  </div>
                </div>
