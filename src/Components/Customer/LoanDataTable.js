...
const LoanDataTable = ({ columns, fetchUrl }) => {
                                        ...
                                        {columns.map((column) => {
                                            if(column === 'action'){
                                                return <td key={column}>
                                                    <div class="row">
                                                    <div class="col-md-2">
                                                        <a class="fa fa-eye" title="View Loan Detail" href={"/loan/detail/"+d.id} ></a>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <a class="fa fa-money" title="pay" href={"/customer-loandetail-payment/"+d.id} ></a>
                                                    </div>
                                                    </div>
                                                </td>
                                            }else{
