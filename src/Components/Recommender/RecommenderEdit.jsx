...
export const RecommenderEdit =()=>{
    ...
    const changeHandler = (e)=>{
        var imagevalue = e.target.files[0];
       setImage(imagevalue);
    ...
    const getrecommender = ()=>{
        axios.get(`api/recommender/${id}`).then(({data})=>{
            setName(data.name);
    ...
    const updateRecommender = async(e)=>{
        e.preventDefault();
        ...
        await axios.post('/api/recommender/'+id,formdata).then(({data})=>{
    ...
    <div class="row">
      ...
      <form onSubmit={updateRecommender}>
            ...
            <div className="row ">
              ...
              {preview  && (
                ...
                <div className="col-md-4">
                    ...
                    <img src={window.baseurl+"/storage/"+image} alt="" height="100" width="100"/>
                    </div>
                </div>
