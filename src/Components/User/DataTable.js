                                            ...
                                            if(column === 'action'){
                                                return <td key={column}>
                                                    <div className='row'>
                                                        ...
                                                        <Link to={`/user-edit/${d.id}`} className='fa fa-edit' title="Edit"></Link>
                                                        </div>
                                                        <div className='col-md-2'>

                                                            <button onClick={()=>deleteuser(d.id)} id={d.id} className='fa fa-trash deleteuser' title="Delete"></button>
